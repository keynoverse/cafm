<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url("assets/{$asset['id']}/edit") ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control <?= $this->hasError('name') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('name', $asset['name']) ?>" required>
                            ...
                            <select name="location_id" class="form-select <?= $this->hasError('location_id') ? 'is-invalid' : '' ?>" required>
                                ...
                                <?php foreach ($locations as $location): ?>
                                    <option value="<?= $location['id'] ?>" 
                                        <?= $this->old('location_id', $asset['location_id']) == $location['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-select <?= $this->hasError('type') ? 'is-invalid' : '' ?>" required>
                                ...
                                <option value="furniture" <?= $this->old('type', $asset['type']) === 'furniture' ? 'selected' : '' ?>>Furniture</option>
                                <option value="equipment" <?= $this->old('type', $asset['type']) === 'equipment' ? 'selected' : '' ?>>Equipment</option>
                                <option value="electronics" <?= $this->old('type', $asset['type']) === 'electronics' ? 'selected' : '' ?>>Electronics</option>
                                <option value="other" <?= $this->old('type', $asset['type']) === 'other' ? 'selected' : '' ?>>Other</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="model" class="form-control <?= $this->hasError('model') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('model', $asset['model']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="serial_number" class="form-control <?= $this->hasError('serial_number') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('serial_number', $asset['serial_number']) ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="purchase_date" class="form-control <?= $this->hasError('purchase_date') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('purchase_date', $asset['purchase_date']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="purchase_price" class="form-control <?= $this->hasError('purchase_price') ? 'is-invalid' : '' ?>" 
                                    value="<?= $this->old('purchase_price', $asset['purchase_price']) ?>" step="0.01" min="0">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="warranty_expiry" class="form-control <?= $this->hasError('warranty_expiry') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('warranty_expiry', $asset['warranty_expiry']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select <?= $this->hasError('status') ? 'is-invalid' : '' ?>" required>
                                <option value="active" <?= $this->old('status', $asset['status']) === 'active' ? 'selected' : '' ?>>Active</option>
                                <option value="maintenance" <?= $this->old('status', $asset['status']) === 'maintenance' ? 'selected' : '' ?>>Maintenance</option>
                                <option value="inactive" <?= $this->old('status', $asset['status']) === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control <?= $this->hasError('description') ? 'is-invalid' : '' ?>" 
                                rows="3"><?= $this->old('description', $asset['description']) ?></textarea>
