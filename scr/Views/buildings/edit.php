<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url("buildings/{$building['id']}/edit") ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control <?= $this->hasError('name') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('name', $building['name']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="address" class="form-control <?= $this->hasError('address') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('address', $building['address']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="city" class="form-control <?= $this->hasError('city') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('city', $building['city']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="state" class="form-control <?= $this->hasError('state') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('state', $building['state']) ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="country" class="form-control <?= $this->hasError('country') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('country', $building['country']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="postal_code" class="form-control <?= $this->hasError('postal_code') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('postal_code', $building['postal_code']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select <?= $this->hasError('status') ? 'is-invalid' : '' ?>" required>
                                <option value="active" <?= $this->old('status', $building['status']) === 'active' ? 'selected' : '' ?>>Active</option>
                                <option value="inactive" <?= $this->old('status', $building['status']) === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control <?= $this->hasError('description') ? 'is-invalid' : '' ?>" 
                                rows="3"><?= $this->old('description', $building['description']) ?></textarea>
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class='bx bx-save'></i> Update Building
                    </button>
                </div>
            </form>
        </div>
