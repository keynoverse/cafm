<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Create Facility Booking</h1>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url('facility-bookings/create') ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="facility_id" class="form-select <?= $this->hasError('facility_id') ? 'is-invalid' : '' ?>" required>
                                ...
                                <?php foreach ($facilities as $facility): ?>
                                    <option value="<?= $facility['id'] ?>" <?= $this->old('facility_id') == $facility['id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="start_time" 
                                        ...
                                        value="<?= $this->old('start_time') ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="end_time" 
                                        ...
                                        value="<?= $this->old('end_time') ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="purpose" class="form-control <?= $this->hasError('purpose') ? 'is-invalid' : '' ?>" 
                                rows="3" required><?= $this->old('purpose') ?></textarea>
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class='bx bx-save'></i> Create Booking
                    </button>
                </div>
            </form>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`<?= $this->url('facility-bookings/check-availability') ?>?facility_id=${facilityId}&start_time=${startTime}&end_time=${endTime}`);
