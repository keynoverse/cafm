<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Add Inventory Item</h1>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url('inventory/create') ?>" data-validate>
                <?= $this->csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="form-select <?= $this->hasError('category_id') ? 'is-invalid' : '' ?>">
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?= $category['id'] ?>" <?= $this->old('category_id') == $category['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="quantity" class="form-control <?= $this->hasError('quantity') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('quantity') ?>" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="min_quantity" class="form-control <?= $this->hasError('min_quantity') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('min_quantity') ?>" min="0" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" class="form-control <?= $this->hasError('price') ? 'is-invalid' : '' ?>" 
                                    value="<?= $this->old('price') ?>" min="0" step="0.01" required>
                            </div>
