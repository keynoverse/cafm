<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Create Preventive Maintenance Task</h1>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url('preventive-maintenance/create') ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="frequency" class="form-select <?= $this->hasError('frequency') ? 'is-invalid' : '' ?>" required>
                                ...
                                <option value="daily" <?= $this->old('frequency') == 'daily' ? 'selected' : '' ?>>Daily</option>
                                <option value="weekly" <?= $this->old('frequency') == 'weekly' ? 'selected' : '' ?>>Weekly</option>
                                <option value="monthly" <?= $this->old('frequency') == 'monthly' ? 'selected' : '' ?>>Monthly</option>
                                <option value="quarterly" <?= $this->old('frequency') == 'quarterly' ? 'selected' : '' ?>>Quarterly</option>
                                <option value="yearly" <?= $this->old('frequency') == 'yearly' ? 'selected' : '' ?>>Yearly</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="next_due" class="form-control <?= $this->hasError('next_due') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('next_due') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control <?= $this->hasError('description') ? 'is-invalid' : '' ?>" 
                                rows="10" required><?= $this->old('description') ?></textarea>
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class='bx bx-save'></i> Create Task
                    </button>
                </div>
            </form>
        </div>
