<div class="container-fluid">
    <div class="row mb-4">
        ...
        <div class="col text-end">
            <?php if ($this->user['role'] === 'admin'): ?>
                <a href="<?= $this->url('rooms/create') ?>" class="btn btn-primary">
                    <i class='bx bx-plus'></i> New Room
                </a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title text-muted">Active Rooms</h6>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title text-muted">Inactive Rooms</h6>
                    <h2 class="mb-0"><?= $stats['inactive_rooms'] ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?= $this->url('rooms') ?>" class="row g-3">
                <div class="col-md-4">
                    <input type="text" name="query" class="form-control" placeholder="Search rooms..." 
                        value="<?= $_GET['query'] ?? '' ?>">
                </div>
                <div class="col-md-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <?php if ($this->user['role'] === 'admin'): ?>
                                                <a href="<?= $this->url("rooms/{$room['id']}/edit") ?>" 
                ...
                <nav class="mt-4">
                    <ul class="pagination justify-content-center">
                        <?php if ($currentPage > 1): ?>
                            <li class="page-item">
                                <a class="page-link" href="<?= $this->url('rooms', ['page' => $currentPage - 1]) ?>">
                                    Previous
                                </a>
                            </li>
                        <?php endif; ?>
