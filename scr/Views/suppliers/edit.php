<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url("suppliers/{$supplier['id']}/edit") ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control <?= $this->hasError('name') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('name', $supplier['name']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="contact_person" class="form-control <?= $this->hasError('contact_person') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('contact_person', $supplier['contact_person']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control <?= $this->hasError('email') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('email', $supplier['email']) ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone" class="form-control <?= $this->hasError('phone') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('phone', $supplier['phone']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" class="form-control <?= $this->hasError('address') ? 'is-invalid' : '' ?>" 
                                rows="3" required><?= $this->old('address', $supplier['address']) ?></textarea>
