<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            <h1 class="h3">Edit Work Order</h1>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?= $this->url("work-orders/{$workOrder['id']}/edit") ?>" data-validate>
                <?= $this->csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control <?= $this->hasError('title') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('title', $workOrder['title']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control <?= $this->hasError('description') ? 'is-invalid' : '' ?>" 
                                rows="3" required><?= $this->old('description', $workOrder['description']) ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="priority" class="form-select <?= $this->hasError('priority') ? 'is-invalid' : '' ?>" required>
                                ...
                                <option value="low" <?= $this->old('priority', $workOrder['priority']) === 'low' ? 'selected' : '' ?>>Low</option>
                                <option value="medium" <?= $this->old('priority', $workOrder['priority']) === 'medium' ? 'selected' : '' ?>>Medium</option>
                                <option value="high" <?= $this->old('priority', $workOrder['priority']) === 'high' ? 'selected' : '' ?>>High</option>
                                <option value="urgent" <?= $this->old('priority', $workOrder['priority']) === 'urgent' ? 'selected' : '' ?>>Urgent</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select <?= $this->hasError('status') ? 'is-invalid' : '' ?>" required>
                                <option value="pending" <?= $this->old('status', $workOrder['status']) === 'pending' ? 'selected' : '' ?>>Pending</option>
                                <option value="in_progress" <?= $this->old('status', $workOrder['status']) === 'in_progress' ? 'selected' : '' ?>>In Progress</option>
                                <option value="completed" <?= $this->old('status', $workOrder['status']) === 'completed' ? 'selected' : '' ?>>Completed</option>
                                <option value="cancelled" <?= $this->old('status', $workOrder['status']) === 'cancelled' ? 'selected' : '' ?>>Cancelled</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="asset_id" class="form-select <?= $this->hasError('asset_id') ? 'is-invalid' : '' ?>">
                                ...
                                <?php foreach ($assets as $asset): ?>
                                    <option value="<?= $asset['id'] ?>" <?= $this->old('asset_id', $workOrder['asset_id']) == $asset['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="location_id" class="form-select <?= $this->hasError('location_id') ? 'is-invalid' : '' ?>">
                                ...
                                <?php foreach ($locations as $location): ?>
                                    <option value="<?= $location['id'] ?>" <?= $this->old('location_id', $workOrder['location_id']) == $location['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="assigned_to" class="form-select <?= $this->hasError('assigned_to') ? 'is-invalid' : '' ?>">
                                ...
                                <?php foreach ($users as $user): ?>
                                    <option value="<?= $user['id'] ?>" <?= $this->old('assigned_to', $workOrder['assigned_to']) == $user['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="due_date" class="form-control <?= $this->hasError('due_date') ? 'is-invalid' : '' ?>" 
                                value="<?= $this->old('due_date', $workOrder['due_date']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="estimated_cost" class="form-control <?= $this->hasError('estimated_cost') ? 'is-invalid' : '' ?>" 
                                    value="<?= $this->old('estimated_cost', $workOrder['estimated_cost']) ?>" step="0.01" min="0">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="actual_cost" class="form-control <?= $this->hasError('actual_cost') ? 'is-invalid' : '' ?>" 
                                    value="<?= $this->old('actual_cost', $workOrder['actual_cost']) ?>" step="0.01" min="0">
                            </div>
                ...
                <div class="text-end mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class='bx bx-save'></i> Update Work Order
                    </button>
                </div>
            </form>
        </div>
